...
internal class KClassBuilder(
    ...
    fun generateProxy(): FileSpec {
        ...
        val proxyBuilder = TypeSpec.classBuilder(proxyClassName)
            ...
            .addAnnotation(AnnotationSpec.builder(Suppress::class).addMember("\"UNCHECKED_CAST\"").addMember("\"DEPRECATION\"").addMember("\"VARIABLE_WITH_REDUNDANT_INITIALIZER\"").addMember("\"SENSELESS_COMPARISON\"").addMember("\"USELESS_CAST\"").addMember("\"UNNECESSARY_NOT_NULL_ASSERTION\"").build())
            .addModifiers(KModifier.PUBLIC, KModifier.OPEN)
            .addSuperinterface(RemoterProxy::class)
    ...
    fun generateStub(): FileSpec {
        ...
        val stubClassBuilder = TypeSpec.classBuilder(stubClassName)
            .addModifiers(KModifier.PUBLIC, KModifier.OPEN)
            .addSuperinterface(RemoterStub::class)
